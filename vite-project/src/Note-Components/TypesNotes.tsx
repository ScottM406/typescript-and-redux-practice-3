const TypeNotes = () => {
  ...
  //DATA TYPE - NEVER - effectively thows an error whenever it is defined (HARDLY EVER USED)

  const var2: never = true; // error: Type 'true' is not assignable to type 'never'.

  //DATA TYPES - UNDEFINED AND NULL - refer to JavaScript primitives 'undfined' and 'null' - hardly ever used.
  ...
  return (
    <div>
      <h2>Refer to Typenotes.tsx in VScode for notes on types.</h2>
    </div>
  )
